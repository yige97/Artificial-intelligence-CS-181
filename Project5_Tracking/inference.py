...
class DiscreteDistribution(dict):
    ...
    def sample(self):
        ...
        for item in self.items():
            sum_val = sum_val + item[1]
            if random_val < sum_val:
                return item[0]
    ...
    def elapseTime(self, gameState):
        ...
        for oldPosition in self.allPositions:
            ...
            for newPosition in newPosDist.keys():
                dist[newPosition] += self.beliefs[oldPosition] * newPosDist[newPosition]
        self.beliefs = dist
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        while number > 0:
            if number > len(self.legalPositions):
                self.particles += self.legalPositions
                number -= len(self.legalPositions)
            else:
                self.particles += self.legalPositions[:number]
                break
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for cur in self.particles:
            self.beliefs[cur] += self.getObservationProb(observation,pacmanPosition,cur,jailPosition)
...
class JointParticleFilter(ParticleFilter):
    ...
    def initializeUniformly(self, gameState):
        ...
        random.shuffle(possibleGhostStates)
        number = self.numParticles
        # while number > len(possibleGhostStates):
        #     self.particles += possibleGhostStates
        #     number -= len(possibleGhostStates)

        # self.particles += possibleGhostStates[:number]
        for i in range(number):
            self.particles.append(possibleGhostStates[i % len(possibleGhostStates)])
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for cur in self.particles:
            ...
            for i in range(self.numGhosts):
                ...
                mulProb *= self.getObservationProb(noisy_dist, pacmanPosition, cur[i], self.getJailPosition(i))
            dist[cur] += mulProb
